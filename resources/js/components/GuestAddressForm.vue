            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        :class="
                            guestAddressStore.errors && guestAddressStore.errors?.flat_no
                                ? 'border-red-500'
                                : 'border-slate-200'
                        "
                    />
                    <span
                        v-if="guestAddressStore.errors && guestAddressStore.errors?.flat_no"
                        class="text-red-500 text-sm"
                ...
                <div>
                    ...
                    <input
                        ...
                        class="form-input"
                        :class="
                            guestAddressStore.errors && guestAddressStore.errors?.post_code
                                ? 'border-red-500'
                                : 'border-slate-200'
                        "
                    />
                    <span
                        v-if="guestAddressStore.errors && guestAddressStore.errors?.post_code"
                        class="text-red-500 text-sm"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                <div>
                    ...
                    <input
                        ...
                        class="form-input"
                        :class="
                            guestAddressStore.errors && guestAddressStore.errors?.address_line
                                ? 'border-red-500'
                                : 'border-slate-200'
                        "
                    />
                    <span
                        v-if="guestAddressStore.errors && guestAddressStore.errors?.address_line"
                        class="text-red-500 text-sm"
                ...
                <div>
                    ...
                    <input
                        type="text"
                        id="address2"
                        v-model="guestAddressStore.address_line2"
                        :placeholder="$t('Enter address 2')"
                        value=""
                        class="form-input"
                        :class="
                            guestAddressStore.errors && guestAddressStore.errors?.address_line2
                                ? 'border-red-500'
                                : 'border-slate-200'
                        "
                    />
                    <span
                        v-if="guestAddressStore.errors && guestAddressStore.errors?.address_line2"
                        class="text-red-500 text-sm"
                    >
                        {{ guestAddressStore.errors?.address_line2[0] }}
                    </span>
                </div>
            </div>
                    ...
                    <div class="flex items-center flex-wrap gap-2">
                        ...
                        >
                            <input
                                ...
                                value="home"
                                class="radio-btn"
                                :checked="guestAddressStore.address_type === 'home'"
                            />
                        ...
                        >
                            <input
                                ...
                                value="office"
                                class="radio-btn"
                                :checked="guestAddressStore.address_type === 'office'"
                            />
                            <span class="text-base font-normal">{{
                                $t("OFFICE")
                            }}</span>
                        ...
                        >
                            <input
                                ...
                                value="other"
                                class="radio-btn"
                                :checked="guestAddressStore.address_type === 'other'"
                            />
                            <span class="text-base font-normal">{{
                                $t("OTHER")
                            }}</span>
